  ...
  useEffect(() => {
    ...
    productsApi
      ...
      .catch((err) => {
        ...
        setError(`${err.message}. Đang hiển thị dữ liệu fallback.`);
      })
            ...
            <div className="rounded-xl border border-line bg-white p-5 shadow-sm">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-[#c1c6d6] pl-9 pr-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10"
                  ...
                  <li key={cat}>
                    <button
                      ...
                      className={`w-full rounded-lg px-3 py-2 text-left text-sm font-medium transition-all ${
                        filters.category === cat ? "bg-primary text-white shadow-sm" : "text-[#414754] hover:bg-soft"
                      }`}
                    >
                      {cat}
                    </button>
            ...
            <div className="rounded-xl border border-line bg-white p-5 shadow-sm">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Từ"
                  className="h-9 min-w-0 flex-1 rounded-lg border border-[#c1c6d6] px-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10"
                />
                <input
                  type="number"
          ...
          <section className="min-w-0 flex-1">
            <div className="mb-6 flex items-center justify-between rounded-xl border border-line bg-white px-4 py-3 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <select
                  ...
                  className="h-9 rounded-lg border border-[#c1c6d6] bg-white px-3 pr-8 text-sm text-ink outline-none focus:border-primary"
                >
            ...
            {productRows.length === 0 ? (
              <div className="rounded-xl border border-line bg-white p-16 text-center shadow-sm">
                ...
                <p className="text-sm text-[#414754]">Hãy thử thay đổi bộ lọc hoặc từ khóa tìm kiếm.</p>
              </div>
            ) : (
