...
const seedCategories = [
  ...
  { id: "cat-accessory", name: "Phụ kiện", slug: "phu-kien" },
  { id: "cat-watch", name: "Đồng hồ", slug: "dong-ho" },
];

const IN_THE_BOX = {
  "Điện thoại": ["Điện thoại", "Cáp sạc USB-C (1m)", "Củ sạc 20W", "Hướng dẫn sử dụng", "Kim chọc SIM"],
  "Laptop": ["Laptop", "Cáp sạc chính hãng", "Túi đựng", "Hướng dẫn bảo hành"],
  "Tablet": ["Tablet", "Cáp USB-C (1m)", "Củ sạc 20W", "Kim chọc SIM", "Hướng dẫn sử dụng"],
  "Phụ kiện": ["Thiết bị chính", "Cáp kết nối", "Hướng dẫn sử dụng nhanh", "Phiếu bảo hành"],
  "Đồng hồ": ["Đồng hồ", "Dây đeo dự phòng", "Cáp sạc", "Hướng dẫn sử dụng", "Phiếu bảo hành"],
};

const LONG_DESCRIPTIONS = {
  "Điện thoại": "Sản phẩm được thiết kế dành cho những người dùng đòi hỏi sự hoàn hảo trong từng trải nghiệm. Với chip xử lý thế hệ mới nhất, màn hình sắc nét và hệ thống camera chuyên nghiệp, đây là lựa chọn hàng đầu cho cả công việc lẫn giải trí. Pin dung lượng lớn kèm sạc nhanh đảm bảo bạn luôn sẵn sàng cho mọi nhu cầu trong suốt cả ngày dài.",
  "Laptop": "Được xây dựng cho những người dùng chuyên nghiệp cần hiệu năng tối đa. Với cấu hình mạnh mẽ, màn hình sắc nét và thiết kế mỏng nhẹ, sản phẩm này là người bạn đồng hành lý tưởng trong công việc, học tập và sáng tạo nội dung. Thời lượng pin lâu giúp bạn làm việc liên tục mà không lo hết pin.",
  "Tablet": "Sự kết hợp hoàn hảo giữa màn hình rộng lớn và tính di động của thiết bị cầm tay. Lý tưởng cho đọc sách, xem phim, học trực tuyến và làm việc nhẹ. Màn hình có độ phân giải cao và tần số quét lớn đem lại trải nghiệm mượt mà, sắc nét.",
  "Phụ kiện": "Sản phẩm phụ kiện chính hãng được thiết kế để nâng cao trải nghiệm sử dụng thiết bị của bạn. Chất liệu cao cấp, độ bền tốt và khả năng tương thích rộng. Tất cả sản phẩm đều trải qua kiểm định chất lượng nghiêm ngặt trước khi đến tay người dùng.",
  "Đồng hồ": "Đồng hồ thông minh thế hệ mới với vô số cảm biến sức khoẻ tiên tiến, theo dõi hoạt động 24/7 và kết nối không dây với điện thoại. Thiết kế sang trọng, dây đeo thoải mái, màn hình sắc nét luôn bật giúp bạn không bỏ lỡ bất kỳ thông báo hay dữ liệu sức khoẻ nào.",
};
